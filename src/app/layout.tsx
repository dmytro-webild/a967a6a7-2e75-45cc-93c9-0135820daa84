...
export const metadata: Metadata = {
  title: "Premium Men's Watches | LUXOR WATCHES Store",  description: "Discover luxury men's wrist watches from premium brands. Explore best-selling, new arrivals, and sport watches. Free shipping, 30-day warranty, secure checkout.",  keywords: "men's watches, luxury watches, wrist watches, premium timepieces, watch store, chronograph watches",  metadataBase: new URL("https://luxorwatches.com"),
  alternates: {
    canonical: "https://luxorwatches.com"
  },
  openGraph: {
    title: "Premium Men's Watches | LUXOR WATCHES",    description: "Discover the finest collection of luxury men's wrist watches with free shipping and 30-day warranty.",    siteName: "LUXOR WATCHES",    type: "website",    url: "https://luxorwatches.com",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/pensive-bearded-man-dark-suit-is-checking-what-time-is-now-dark-photo-studio_613910-12654.jpg",        alt: "Premium luxury men's watch collection"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",    title: "Premium Men's Watches | LUXOR WATCHES",    description: "Luxury timepieces for the discerning gentleman. Shop now.",    images: ["http://img.b2bpic.net/free-photo/pensive-bearded-man-dark-suit-is-checking-what-time-is-now-dark-photo-studio_613910-12654.jpg"]
  },
  robots: {
    index: true,
    follow: true
